...
public interface StudentQueryMapper {
     ...
     * @return 结果
     */
    List<Student> findStudentByBirthdayBetween(@Param("birthdayFrom") String birthdayFrom, @Param("birthdayTo") String birthdayTo);
     ...
     * @return 结果
     */
    List<Student> findStudentByIdBetween(@Param("idFrom") int idFrom, @Param("idTo") int idTo);
     ...
     * @return 结果
     */
    List<Map<String, Integer>> findRow();
     ...
     * @return 结果
     */
    List<Student> findAllLimit(@Param("index") int index, @Param("pageSize") int pageSize);
}
